...
```sh
curl -L --progress-bar -o "$HOME/.BingWallpaper.sh" "https://raw.githubusercontent.com/arghya339/BingWallpaper/refs/heads/main/bash/BingWallpaper.sh" && bash ~/.BingWallpaper.sh
```
```
bingwall
```
